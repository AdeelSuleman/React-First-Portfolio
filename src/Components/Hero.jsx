        ...
        <div className="w-full lg:w-1/2">
          <div className="flex justify-center lg:p-8 ">
            <motion.img
              ...
              trasnsition={{ duration: 1, delay: 1.5 }}
            />
          </div>
        </div>
        <div className="w-full lg:w-1/2">
          <motion.div
            ...
            <motion.h2 
                ...
                className="pb-2 text-4xl tracking-tighter lg:text-8xl bg-gradient-to-r from-stone-300 to-stone-600 bg-clip-text text-transparent">
              {" "}
              Adeel Suleman
            </motion.h2>
